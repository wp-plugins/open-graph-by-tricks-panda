...
function tricks_panda_og_register_settings()
{
	...
	add_option('tricks_panda_og_site_type');
	add_option('tricks_panda_og_fb_page');
	add_option('tricks_panda_og_app_id');
	register_setting('default', 'tricks_panda_og_default');
	register_setting('default', 'tricks_panda_og_site_type');
	register_setting('default', 'tricks_panda_og_fb_page');
	register_setting('default', 'tricks_panda_og_app_id');
}
...
<div class="wrap">
		...
		<h3>You can configure Open Graph settings from the form below:</h3>
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" size="50px" id="tricks_panda_og_default" name="tricks_panda_og_default" value="<?php
	...
	if (get_option('tricks_panda_og_site_type') == blog) echo 'selected="selected"'; ?>>Blog</option>
				...
				<tr valign="top">
					...
					<td><input type="text" size="50px" id="tricks_panda_og_fb_page" name="tricks_panda_og_fb_page" value="<?php
	echo get_option('tricks_panda_og_fb_page'); ?>" /></td>
				...
				<tr valign="top">
					...
					<td><input type="text" size="50px" id="tricks_panda_og_app_id" name="tricks_panda_og_app_id" value="<?php
